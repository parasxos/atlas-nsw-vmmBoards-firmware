...
HD_PWD='/home/pmoschov/myGitRepos/atlas-nsw-mmfe8-firmware/sources/MDT_446/MDT_446.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mmfe8_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mmfe8_top.tcl -notrace
